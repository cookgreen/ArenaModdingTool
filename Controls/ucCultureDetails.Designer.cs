namespace ArenaModdingTool.Controls
{
    partial class ucCultureDetails
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label6.Text = "elite basic troop";
			...
			this.label10.Text = "ranged elite militia troop";
			...
			this.label12.Text = "town edge number";
			...
			this.label13.Text = "villager party template";
			...
			this.label14.Text = "default party template";
			...
			this.label11.Text = "caravan party template";
			...
			this.label15.Text = "elite caravan party template";
			...
			this.label16.Text = "militia party template";
			...
			this.label17.Text = "rebels party template";
			...
			this.label20.Text = "prosperity bonus";
			...
			this.label21.Text = "encounter background mesh";
			...
			this.label23.Text = "tournament master";
			...
			this.label25.Text = "caravan master";
			...
			this.label26.Text = "armed trader";
			...
			this.label36.Text = "default face key";
